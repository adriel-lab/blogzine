	...
	<div class="container">
		...
		<div class="row pt-5">
			...
			<div class="col-md-6 col-lg-4 mb-4">
				<img class="light-mode-item" src="<?php echo $logo;  ?>" alt="logo">			
				<img class="dark-mode-item" src="<?php echo $logo_light;  ?>" alt="logo">
				...
				<div class="mt-4">©2024 <a href="https://www.News.com/" class="text-reset btn-link" target="_blank">News</a>. All rights reserved
				</div>
			</div>
