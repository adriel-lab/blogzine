...
<?php 
        ...
        $avatar = "http://localhost/Lucas/assets/images/avatar/08.jpg";
		...
		<nav class="navbar navbar-expand-xl">
			<div class="container">
				...
				<a class="navbar-brand me-3" href="index-2.html">
					<img class="navbar-brand-item light-mode-item" src="<?php echo $logo;  ?>" alt="logo">
					<img class="navbar-brand-item dark-mode-item" src="<?php echo $logo_light;  ?>" alt="logo">
				</a>
				<!-- Logo END -->
					...
					<ul class="navbar-nav navbar-nav-scroll mx-auto">
						...
						<li class="nav-item dropdown">
							...
							<ul class="dropdown-menu" aria-labelledby="pagesMenu">
								...
								<li> <a class="dropdown-item" href="https://support.News.com/" target="_blank"> <i class="text-warning fa-fw bi bi-life-preserver me-2"></i>Support</a></li>
								...
								<li><a class="dropdown-item" href="https://themes.getbootstrap.com/store/News/" target="_blank"> <i class="text-success fa-fw bi bi-cloud-download-fill me-2"></i>Buy blogzine!</a> </li>
							</ul>
						</li>
					</ul>
				...
				<div class="nav flex-nowrap align-items-center">
											...
											<a href="#" class="list-group-item-action border-0 border-bottom d-flex p-3">
												<div class="me-3">
													<div class="avatar avatar-sm">
														<img class="avatar-img rounded-circle" src="<?php echo $avatar;  ?>" alt="avatar">
													</div>
												</div>
												<div>
					...
					<div class="nav-item ms-2 ms-md-3 dropdown">
						...
						<ul class="dropdown-menu dropdown-animation dropdown-menu-end shadow pt-3" aria-labelledby="profileDropdown">
							...
							<li class="px-3">
								<div class="d-flex align-items-center">
									...
									<div class="avatar me-3">
										<img class="avatar-img rounded-circle shadow" src="<?php echo $avatar;  ?>" alt="avatar">
									</div>
									<div>
							...
							<li><a class="dropdown-item" href="logout.php"><i class="bi bi-power fa-fw me-2"></i>Sign Out</a></li>
